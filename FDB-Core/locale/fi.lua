local Translations = {
    error = {
     ...
     duplicate_license = '[FDBCORE] - Rockstar-lisenssin kaksoiskappale lÃ¶ydetty',
     no_valid_license = '[FDBCORE] - Kelvollista Rockstar-lisenssiÃ¤ ei lÃ¶ytynyt',
     not_whitelisted = '[FDBCORE] - Et ole sallittujen luettelossa tÃ¤lle palvelimelle',
     ...
     ban_table_not_found = '[FDBCORE] - Kieltotaulukkoa ei lÃ¶ydy tietokannasta. Varmista, ettÃ¤ olet tuonut SQL-tiedoston oikein.',
     connecting_database_error = '[FDBCORE] - Virhe muodostettaessa yhteyttÃ¤ tietokantaan. Varmista, ettÃ¤ SQL-palvelin on kÃ¤ynnissÃ¤ ja ettÃ¤ server.cfg-tiedoston tiedot ovat oikein.',
     connecting_database_timeout = '[FDBCORE] - Tietokantayhteys aikakatkaistiin. Varmista, ettÃ¤ SQL-palvelin on kÃ¤ynnissÃ¤ ja ettÃ¤ server.cfg-tiedoston tiedot ovat oikein.',
    },
    success = {
