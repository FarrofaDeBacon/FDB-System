...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-valentine', 'bau', '{"x":-314.15,"y":804.28,"z":118.98}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-rhodes', 'bau', '{"x":1330.67,"y":-1293.44,"z":77.02}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-annesburg', 'bau', '{"x":2932.47,"y":1365.38,"z":45.2}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-stdenis', 'bau', '{"x":2860.86,"y":-1202.19,"z":49.59}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-tumbleweed', 'bau', '{"x":-5484.54,"y":-2937.99,"z":-0.4}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-armadillo', 'bau', '{"x":-3685.85,"y":-2623.34,"z":-13.43}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-blackwater', 'bau', '{"x":-783.27,"y":-1322.15,"z":43.88}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('gen-vanhorn', 'bau', '{"x":3027.1,"y":562.29,"z":44.72}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('wep-valentine', 'bau', '{"x":-279.67,"y":778.94,"z":119.5}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('wep-tumbleweed', 'bau', '{"x":-5504.91,"y":-2963.95,"z":-0.64}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('wep-stdenis', 'bau', '{"x":2718.64,"y":-1286.9,"z":49.64}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('wep-rhodes', 'bau', '{"x":1323.81,"y":-1323.02,"z":77.89}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('wep-annesburg', 'bau', '{"x":2949.92,"y":1319.44,"z":44.82}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('blk-saloon', 'bau', '{"x":-816.19,"y":-1319.29,"z":43.68}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('val-saloon', 'bau', '{"x":-311.94,"y":806.14,"z":118.98}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('lab-saloon', 'bau', '{"x":2641.37,"y":-1226.13,"z":53.38}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('rho-saloon', 'bau', '{"x":1341.75,"y":-1374.71,"z":80.48}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('ann-saloon', 'bau', '{"x":2967.63,"y":1353.66,"z":44.86}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('old-saloon', 'bau', '{"x":2949.67,"y":528.08,"z":45.34}');
...
INSERT IGNORE INTO shop_stations (shop_id, type, position) VALUES ('tumble-saloon', 'bau', '{"x":-5517,"y":-2906.52,"z":-1.75}');
