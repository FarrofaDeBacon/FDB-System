...
{
    {name = 'Valentine Medic', prompt = 'medic', coords = vector3(-289.46, 806.82, 119.39 - 0.08), showblip = true},
    {name = 'Saint Denis Medic', prompt = 'medic', coords = vector3(2725.33, -1067.42, 47.4 - 0.8), showblip = true}
}
