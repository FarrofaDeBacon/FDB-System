    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
                    setCharactersList()
                    $.post('https://fdb-multicharacter/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('https://fdb-multicharacter/removeBlur');
                    }, 2000);
                }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://fdb-multicharacter/closeUI');
    $.post('https://fdb-multicharacter/disconnectButton');
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('https://fdb-multicharacter/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://fdb-multicharacter/createNewCharacter', JSON.stringify({
        cid: cid,
    }));
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://fdb-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://fdb-multicharacter/selectCharacter', JSON.stringify({
