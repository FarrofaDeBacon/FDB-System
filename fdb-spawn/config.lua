...
Config.SpawnLocations = {
    { id = 'valentine', label = 'Valentine', desc = 'The Heartlands', image = 'nui://fdb-spawn/html/img/valentine.jpg', coords = vec4(-169.47, 629.38, 114.03, 236.72) },
    { id = 'saintdenis', label = 'Saint Denis', desc = 'The Big City', image = 'nui://fdb-spawn/html/img/saintdenis.jpg', coords = vec4(2694.69, -1448.48, 46.27, 23.27) },
}
