...
RegisterNetEvent('fdb-adminmenu:client:devoptions', function()
        ...
        options = {
            {
                ...
                event = 'fdb-adminmenu:client:horseoptions',
                arrow = true
            },
            {
                ...
                event = 'fdb-adminmenu:client:copycoordsmenu',
                arrow = true
            },
            {
                ...
                event = 'fdb-adminmenu:client:testanimation',
                arrow = true
            },
            {
                ...
                event = 'fdb-adminmenu:client:gethash',
                arrow = true
            },
            {
                ...
                event = 'fdb-adminmenu:client:toggledoorid',
                arrow = true
            },
            {
                ...
                event = 'fdb-adminmenu:client:spawnped',
                arrow = true
            },
        }
    })
...
-- spawn admin horse
RegisterNetEvent('fdb-adminmenu:client:horseoptions', function()
    local option = {}
    ...
    TriggerEvent('fdb-adminmenu:client:spawnhorse', input[1])

end)

-- spawn horse / warp player / set networked
RegisterNetEvent('fdb-adminmenu:client:spawnhorse', function(HorseHash)
...
-- get entity hash
RegisterNetEvent('fdb-adminmenu:client:gethash', function()
...
-- npc/amimal spawner
RegisterNetEvent('fdb-adminmenu:client:spawnped', function()
    ...
    if not input then return end
    local hash = joaat(input[1])
    TriggerEvent('fdb-adminmenu:client:dospawnped', hash, input[2], input[3], input[4], input[5])
end)

RegisterNetEvent('fdb-adminmenu:client:dospawnped', function(hash, outfit, distance, freeze, dead)
