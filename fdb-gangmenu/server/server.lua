...
-- stash
----------------
RegisterNetEvent('fdb-gangmenu:server:openinventory', function(stashName)
    local src = source
...
-- money
-----------------------------------------------------------------------
RegisterNetEvent("fdb-gangmenu:server:withdrawMoney", function(amount)
    local src = source
    local Player = FDBCore.Functions.GetPlayer(src)
    ...
    if RemoveGangMoney(gang, amount) then
        ...
        TriggerEvent('fdb-log:server:CreateLog', 'gangmenu', locale('sv_25'), 'yellow', Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname .. ' ' .. locale('sv_51') .. ' $ ' .. amount .. ' (' .. gang .. ')', false)
...
RegisterNetEvent("fdb-gangmenu:server:depositMoney", function(amount)
    local src = source
    local Player = FDBCore.Functions.GetPlayer(src)
    ...
    if Player.Functions.RemoveMoney("cash", amount) then
        ...
        TriggerEvent('fdb-log:server:CreateLog', 'gangmenu', locale('sv_29'), 'yellow', Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname ..' ' .. locale('sv_52') .. ' $ '.. amount .. ' (' .. gang .. ')', false)
...
FDBCore.Functions.CreateCallback('fdb-gangmenu:server:GetAccount', function(_, cb, GangName)
...
-- Get Employees
-----------------------------------------------------------------------
FDBCore.Functions.CreateCallback('fdb-gangmenu:server:GetEmployees', function(source, cb, gangname)
    local src = source
    local Player = FDBCore.Functions.GetPlayer(src)
...
-- Grade Change
-----------------------------------------------------------------------
RegisterNetEvent('fdb-gangmenu:server:GradeUpdate', function(data)
    local src = source
    local Player = FDBCore.Functions.GetPlayer(src)
...
-- Fire Member
-----------------------------------------------------------------------
RegisterNetEvent('fdb-gangmenu:server:FireMember', function(target)
    local src = source
    local Player = FDBCore.Functions.GetPlayer(src)
    ...
    if Employee then
        if target ~= Player.PlayerData.citizenid then
            ...
            if Employee.Functions.SetGang("none", '0') then
                TriggerEvent("fdb-log:server:CreateLog", "gangmenu", locale('sv_39'), "orange", Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname ..' ' .. locale('sv_40') ..' ' .. Employee.PlayerData.charinfo.firstname .. " " .. Employee.PlayerData.charinfo.lastname .. " (" .. Player.PlayerData.gang.name .. ")", false)
...
-- Recruit Player
-----------------------------------------------------------------------
RegisterNetEvent('fdb-gangmenu:server:HireMember', function(recruit)
    local src = source
    local Player = FDBCore.Functions.GetPlayer(src)
    ...
    if Target and Target.Functions.SetGang(Player.PlayerData.gang.name, 0) then
        ...
        TriggerEvent('fdb-log:server:CreateLog', 'gangmenu', locale('sv_49'), 'yellow', (Player.PlayerData.charinfo.firstname .. ' ' .. Player.PlayerData.charinfo.lastname)..' ' .. locale('sv_50') ..' ' .. Target.PlayerData.charinfo.firstname .. ' ' .. Target.PlayerData.charinfo.lastname .. ' (' .. Player.PlayerData.gang.name .. ')', false)
    end
end)
...
-----------------------------------------------------------------------
FDBCore.Functions.CreateCallback('fdb-gangmenu:getplayers', function(source, cb)
    local src = source
    local players = {}
...
-------------------------------------------------------------------------------------------
FDBCore.Commands.Add('removegang', locale('sv_admin_usage'), {{name = 'id', help = 'Player ID'}, {name = 'gang', help = 'Gang ID'}}, false, function(source, args)
    local src = source
    ...
    if not FDBCore.Shared.Gangs[gang] then
