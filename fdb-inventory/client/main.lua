...
CreateThread(function()
    ...
    local commands = {
        ...
        [FDBCore.Shared.Keybinds["1"]]     = { command = "slot_1",    disabled = true  }, -- use slot 1 (hold)
        [FDBCore.Shared.Keybinds["2"]]     = { command = "slot_2",    disabled = true  }, -- use slot 2 (hold)
        [FDBCore.Shared.Keybinds["3"]]     = { command = "slot_3",    disabled = true  }, -- use slot 3 (hold)
        [FDBCore.Shared.Keybinds["4"]]     = { command = "slot_4",    disabled = true  }, -- use slot 4 (hold)
        [FDBCore.Shared.Keybinds["5"]]     = { command = "slot_5",    disabled = true  }, -- use slot 5 (hold)
    }
