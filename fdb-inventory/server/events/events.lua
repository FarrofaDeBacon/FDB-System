...
--]]
RegisterNetEvent('fdb-inventory:server:updateHotbar', function(identifier)
    ...
    TriggerClientEvent('fdb-inventory:client:updateHotbar', src, items)
end)
...
--]]
RegisterNetEvent('fdb-inventory:server:SetInventoryData', function(fromInventory, toInventory, fromSlot, toSlot, fromAmount, toAmount)
