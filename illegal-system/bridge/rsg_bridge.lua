--[[
    Implementação de Bridge.* para RSG-Core vanilla.
    Único arquivo que conhece RSGCore.Functions.* — se o cliente trocar
...
function Bridge.HasPermission(source, permission)
    return RSGCore.Functions.HasPermission(source, permission)
end
