    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://fdb-mdtmedic/getWarrants');
        ...
        closeMDT() {
            $.post('http://fdb-mdtmedic/close', JSON.stringify({}));
        },
        getClass(element) {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://fdb-mdtmedic/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://fdb-mdtmedic/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://fdb-mdtmedic/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://fdb-mdtmedic/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('http://fdb-mdtmedic/submitNewReport', JSON.stringify({
        ...
        SubmitNote() {
            if (this.note_new.title && this.note_new.note) {
                $.post('http://fdb-mdtmedic/submitNote', JSON.stringify({
        ...
        OpenOffenderDetailsById(charidentifier) {
            $.post('http://fdb-mdtmedic/getOffender', JSON.stringify({
        ...
        DeleteSelectedReport() {
            $.post('http://fdb-mdtmedic/deleteReport', JSON.stringify({
        ...
        DeleteSelectedNote() {
            $.post('http://fdb-mdtmedic/deleteNote', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://fdb-mdtmedic/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveNoteEditChanges() {
            $.post('http://fdb-mdtmedic/saveNoteChanges', JSON.stringify({
                id: this.note_selected.id,
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://fdb-mdtmedic/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://fdb-mdtmedic/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://fdb-mdtmedic/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
